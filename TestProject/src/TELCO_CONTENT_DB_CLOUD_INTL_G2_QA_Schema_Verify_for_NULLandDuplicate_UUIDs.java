...
public class TELCO_CONTENT_DB_CLOUD_INTL_G2_QA_Schema_Verify_for_NULLandDuplicate_UUIDs {

	private static final String DRIVER = "oracle.jdbc.driver.OracleDriver";
    private static final String HOSTNAME = "a201694-cdp0792a.0908.aws-int.thomsonreuters.com";
    private static final int PORT = 1521;
    private static final String SERVICE_NAME = "pdbp0792_1.a261952290908.amazonaws.com";
    private static final String USERNAME_TDR = "Content";
    private static final String PASSWORD_TDR = "QASECURITY";
    private static final String JDBC_URL = "jdbc:oracle:thin:@" + HOSTNAME + ":" + PORT + "/" + SERVICE_NAME;
    private static final String SCHEMA_NAME = "CLOUD_INTL_G2_QA";
    private static final String MERCHANT_NAME = "Sabrix INTL Tax Data";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (connection != null) {
                 ...
                 */
                Sheet countSheet = workbook.createSheet("TELCO CONTENT DB_" + SCHEMA_NAME + "_NULL UUID COUNT");              
                ...
                countSheet = workbook.createSheet("TELCO CONTENT DB_" + SCHEMA_NAME + "_DUPLICATE UUID COUNT");
