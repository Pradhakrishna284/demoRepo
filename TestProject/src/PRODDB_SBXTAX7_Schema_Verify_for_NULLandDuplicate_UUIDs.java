...
public class PRODDB_SBXTAX7_Schema_Verify_for_NULLandDuplicate_UUIDs {
    ...
    private static final String SCHEMA_NAME = "SBXTAX7";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (connection != null) {
                 ...
                 */
                Sheet countSheet = workbook.createSheet("PROD DB_" + SCHEMA_NAME + "_NULL UUID COUNT");              
                ...
                countSheet = workbook.createSheet("PROD DB_" + SCHEMA_NAME + "_DUPLICATE UUID COUNT");
